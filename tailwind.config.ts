      ...
      typography: ({ theme }: { theme: (key: string) => any }) => ({
        DEFAULT: {
          css: {
            ...
            '--tw-prose-code': theme('colors.foreground'), // Inline code text color
            '--tw-prose-pre-code': theme('colors.foreground'), // Code block text color (will be overridden by syntax highlighter)
            ...
            // Customize code block background slightly for better contrast
             pre: {
               backgroundColor: 'hsl(var(--muted))',
               color: 'hsl(var(--muted-foreground))', // Default text color if syntax highlighting fails
